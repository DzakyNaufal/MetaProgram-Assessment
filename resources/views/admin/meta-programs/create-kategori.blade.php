...
@section('header', 'Tambah Kategori Meta Program')
    ...
    <div class="p-6">
        <div class="max-w-2xl mx-auto">
            <div class="overflow-hidden bg-white shadow-xl sm:rounded-3xl">
                <div class="p-8">
                    <div class="mb-6">
                        <h1 class="text-2xl font-bold text-gray-900">Tambah Kategori Meta Program</h1>
                        <p class="text-gray-600 mt-1">Buat kategori baru untuk mengelompokkan Meta Programs</p>
                    </div>

                    <form action="{{ route('admin.meta-programs.store-kategori') }}" method="POST">
                        @csrf
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" name="name" id="name" required
                                    ...
                                    placeholder="Contoh: THE MENTAL META-PROGRAMS">
                                @error('name')
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center gap-2">
                                    <input type="number" name="timer_duration" id="timer_duration"
                                        ...
                                        value="30" min="1" max="180" placeholder="30">
