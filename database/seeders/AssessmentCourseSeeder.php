...
class AssessmentCourseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Basic 1: Full Assessment - Rp. 999.000
        $basicFull = Course::create([
            'title' => 'Full Assessment - Basic',
            'slug' => 'full-assessment-basic',
            'description' => 'Assessment lengkap untuk mengetahui potensi diri Anda secara menyeluruh. Mencakup 5 kategori: Kepribadian, Gaya Kerja, Komunikasi, Leadership, dan Pertumbuhan.',
        ...
        $catFull1 = Category::create([
            'course_id' => $basicFull->id,
            'name' => 'Kepribadian',
            'slug' => 'kepribadian',
            'description' => 'Kenali tipe kepribadian dasar Anda',
            'icon' => 'user',
            'color' => '#3B82F6',
            'order' => 1,
            'is_active' => true,
        ...
        $catFull2 = Category::create([
            'course_id' => $basicFull->id,
            'name' => 'Gaya Kerja',
            'slug' => 'gaya-kerja',
            'description' => 'Temukan gaya kerja yang paling sesuai',
            'icon' => 'briefcase',
            'color' => '#10B981',
            'order' => 2,
            'is_active' => true,
        ...
        $catFull3 = Category::create([
            'course_id' => $basicFull->id,
            'name' => 'Komunikasi',
            'slug' => 'komunikasi',
            'description' => 'Pahami gaya komunikasi Anda',
            'icon' => 'message-circle',
            'color' => '#8B5CF6',
            'order' => 3,
            'is_active' => true,
        ...
        $catFull5 = Category::create([
            'course_id' => $basicFull->id,
            'name' => 'Pertumbuhan',
            'slug' => 'pertumbuhan',
            'description' => 'Potensi pengembangan diri',
            'icon' => 'trending-up',
            'color' => '#EC4899',
            'order' => 5,
            'is_active' => true,
        ...
        // Questions for Full Assessment
        $this->createQuestion($basicFull, $catFull1, 1, 'Saat menghadapi masalah, Anda lebih cenderung:', [
        ...
        $this->createQuestion($basicFull, $catFull2, 2, 'Lingkungan kerja ideal Anda adalah:', [
        ...
        $this->createQuestion($basicFull, $catFull3, 3, 'Dalam presentasi, Anda lebih suka:', [
        ...
        $this->createQuestion($basicFull, $catFull4, 4, 'Gaya memimpin Anda:', [
        ...
        $this->createQuestion($basicFull, $catFull5, 5, 'Cara Anda beradaptasi dengan perubahan:', [
        ...
        // Basic 2-6: Kategori 1-5 - Rp. 250.000 each

        // Kategori 1 - Kepribadian
        $basicCat1 = Course::create([
            'title' => 'Assessment Kategori 1 - Kepribadian',
            'slug' => 'assessment-kategori-1-kepribadian',
            'description' => 'Kenali tipe kepribadian dasar Anda dan bagaimana hal itu mempengaruhi cara Anda berinteraksi dengan dunia.',
        ...
        $cat1Only = Category::create([
            'course_id' => $basicCat1->id,
            'name' => 'Kepribadian',
            'slug' => 'kepribadian',
            'description' => 'Kenali tipe kepribadian dasar Anda',
            'icon' => 'user',
        ...
        $this->createQuestion($basicCat1, $cat1Only, 1, 'Saat menghadapi masalah, Anda lebih cenderung:', [
            ['option_text' => 'Mencari solusi praktis yang bisa langsung diterapkan', 'talent_type' => 'RES'],
            ['option_text' => 'Menganalisis penyebab masalah secara mendalam', 'talent_type' => 'ANA'],
            ['option_text' => 'Mencari cara kreatif dan unik untuk mengatasinya', 'talent_type' => 'EXP'],
            ['option_text' => 'Mengikuti prosedur yang sudah terbukti berhasil', 'talent_type' => 'CON'],
        ...
        $this->createQuestion($basicCat1, $cat1Only, 2, 'Aktivitas yang paling Anda nikmati:', [
        ...
        $this->createQuestion($basicCat1, $cat1Only, 3, 'Dalam situasi sosial, Anda:', [
        ...
        // Kategori 2 - Gaya Kerja
        $basicCat2 = Course::create([
            'title' => 'Assessment Kategori 2 - Gaya Kerja',
            'slug' => 'assessment-kategori-2-gaya-kerja',
        ...
        $cat2Only = Category::create([
            'course_id' => $basicCat2->id,
            'name' => 'Gaya Kerja',
            'slug' => 'gaya-kerja',
            'description' => 'Temukan gaya kerja yang paling sesuai',
            'icon' => 'briefcase',
        ...
        $this->createQuestion($basicCat2, $cat2Only, 1, 'Lingkungan kerja ideal Anda adalah:', [
            ['option_text' => 'Lapangan atau workshop dengan alat-alat', 'talent_type' => 'RES'],
            ['option_text' => 'Kantor yang rapi dan terorganisir', 'talent_type' => 'CON'],
            ['option_text' => 'Studio ruang kreatif yang bebas', 'talent_type' => 'EXP'],
            ['option_text' => 'Perpustakaan atau laboratorium tenang', 'talent_type' => 'ANA'],
        ...
        $this->createQuestion($basicCat2, $cat2Only, 2, 'Dalam kerja tim, Anda biasanya:', [
        ...
        $this->createQuestion($basicCat2, $cat2Only, 3, 'Cara Anda mengatur waktu:', [
        ...
        $basicCat3 = Course::create([
            'title' => 'Assessment Kategori 3 - Komunikasi',
            'slug' => 'assessment-kategori-3-komunikasi',
        ...
        $cat3Only = Category::create([
            'course_id' => $basicCat3->id,
            'name' => 'Komunikasi',
            'slug' => 'komunikasi',
            'description' => 'Pahami gaya komunikasi Anda',
            'icon' => 'message-circle',
        ...
        $this->createQuestion($basicCat3, $cat3Only, 1, 'Dalam presentasi, Anda lebih suka:', [
            ['option_text' => 'Demonstrasi langsung produk', 'talent_type' => 'RES'],
            ['option_text' => 'Slide yang terstruktur rapi', 'talent_type' => 'CON'],
            ['option_text' => 'Storytelling yang menarik', 'talent_type' => 'EXP'],
            ['option_text' => 'Data dan analisis yang mendalam', 'talent_type' => 'ANA'],
        ...
        $this->createQuestion($basicCat3, $cat3Only, 2, 'Dalam meeting, Anda biasanya:', [
        ...
        $this->createQuestion($basicCat3, $cat3Only, 3, 'Saat berdebat, Anda:', [
        ...
        // Kategori 4 - Leadership
        $basicCat4 = Course::create([
            'title' => 'Assessment Kategori 4 - Leadership',
            'slug' => 'assessment-kategori-4-leadership',
        ...
        $cat4Only = Category::create([
            'course_id' => $basicCat4->id,
            'name' => 'Leadership',
            'slug' => 'leadership',
            'description' => 'Potensi kepemimpinan Anda',
            'icon' => 'users',
        ...
        $this->createQuestion($basicCat4, $cat4Only, 1, 'Gaya memimpin Anda:', [
            ['option_text' => 'Lead by example', 'talent_type' => 'RES'],
            ['option_text' => 'Delegasi dengan jelas', 'talent_type' => 'CON'],
            ['option_text' => 'Inspirasi dan vision', 'talent_type' => 'EXP'],
            ['option_text' => 'Data-driven decision', 'talent_type' => 'ANA'],
        ...
        $this->createQuestion($basicCat4, $cat4Only, 2, 'Tipe bos yang Anda sukai:', [
        ...
        $this->createQuestion($basicCat4, $cat4Only, 3, 'Saat memimpin tim, Anda fokus pada:', [
        ...
        // Kategori 5 - Pertumbuhan
        $basicCat5 = Course::create([
            'title' => 'Assessment Kategori 5 - Pertumbuhan',
            'slug' => 'assessment-kategori-5-pertumbuhan',
        ...
        $cat5Only = Category::create([
            'course_id' => $basicCat5->id,
            'name' => 'Pertumbuhan',
            'slug' => 'pertumbuhan',
            'description' => 'Potensi pengembangan diri',
            'icon' => 'trending-up',
        ...
        $this->createQuestion($basicCat5, $cat5Only, 1, 'Cara Anda beradaptasi dengan perubahan:', [
            ['option_text' => 'Coba dan adaptasi langsung', 'talent_type' => 'RES'],
            ['option_text' => 'Pelajari aturan baru dulu', 'talent_type' => 'CON'],
            ['option_text' => 'Anggap sebagai kesempatan baru', 'talent_type' => 'EXP'],
            ['option_text' => 'Analisis dampak perubahan', 'talent_type' => 'ANA'],
        ...
        $this->createQuestion($basicCat5, $cat5Only, 2, 'Sifat yang ingin Anda kembangkan:', [
        ...
        $this->createQuestion($basicCat5, $cat5Only, 3, 'Cara Anda menghadapi kegagalan:', [
        ...
        // Premium: Rp. 2.500.000 (dengan sesi konsultasi)
        $premium = Course::create([
            'title' => 'Assessment Premium - dengan Konsultasi',
            'slug' => 'assessment-premium-konsultasi',
            'description' => 'Assessment lengkap PLUS sesi konsultasi personal via WhatsApp untuk membahas hasil dan mendapatkan rekomendasi karier yang dipersonalisasi.',
        ...
        // Elite: Rp. 7.500.000 (dengan sesi konsultasi & coaching)
        $elite = Course::create([
            'title' => 'Assessment Elite - dengan Konsultasi & Coaching',
            'slug' => 'assessment-elite-konsultasi-coaching',
            'description' => 'Assessment komprehensif PLUS sesi konsultasi personal dan coaching offline untuk transformasi karier maksimal. Cocok untuk serius mengembangkan potensi diri.',
        ...
        $this->command->info('Assessment Courses seeded successfully!');
        $this->command->info(' - Assessment Basic: 7 courses');
        $this->command->info(' - Assessment Premium: 1 course (with WhatsApp consultation)');
        $this->command->info(' - Assessment Elite: 1 course (with WhatsApp consultation + Offline coaching)');
    }
